...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center relative">
      {/* Settings button */}
      <button
        onClick={() => navigate('/settings')}
        className="absolute top-4 right-4 p-2 text-gray-400 hover:text-indigo-600 hover:bg-white/60 rounded-lg transition-colors"
        title="模型配置管理"
      >
